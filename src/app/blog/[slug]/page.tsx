    ...
    <div className="min-h-screen bg-background text-foreground font-mono">
      ...
      >
        <div className="max-w-3xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          ...
          <span className="text-[11px] text-muted tracking-widest hidden sm:block">{rt}</span>
          <ThemeToggle />
        </div>
      </nav>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="mt-12 mb-10 border border-border rounded-lg overflow-hidden">
          <div className="bg-surface px-4 py-2.5 border-b border-border flex items-center gap-2">
            ...
            <div className="size-2 rounded-full bg-border" />
            <div className="size-2 rounded-full bg-border" />
            <span className="text-[11px] text-muted ml-2 uppercase tracking-widest">
              blog/{slug}.mdx
            </span>
            <div className="ml-auto flex items-center gap-3 text-[11px] text-muted tracking-widest">
              <span>{rt}</span>
          ...
          <div className="px-6 sm:px-8 py-8">
            <div className="flex flex-wrap gap-2 mb-5">
              {post.tags.map((tag) => (
                <span
                  key={tag}
                  className="text-[11px] px-2.5 py-1 border border-brand/30 text-brand tracking-widest uppercase"
                >
                  {tag}
                </span>
              ))}
            ...
            <p className="text-foreground/70 text-base leading-relaxed">{post.excerpt}</p>
          </div>
        </div>
        ...
        <article
          className="
            prose prose-base sm:prose-lg max-w-none pb-20
            ...
            prose-h1:text-3xl prose-h2:text-2xl prose-h2:mt-10 prose-h2:mb-4 prose-h2:border-b prose-h2:border-border prose-h2:pb-3
            prose-h3:text-lg prose-h3:text-brand/90 prose-h3:mt-8
            prose-p:text-foreground/80 prose-p:leading-[1.8] prose-p:my-5
            ...
            prose-blockquote:border-l-2 prose-blockquote:border-brand/40 prose-blockquote:bg-surface/30 prose-blockquote:px-5 prose-blockquote:py-1 prose-blockquote:not-italic prose-blockquote:text-foreground/70
            prose-blockquote:before:content-none prose-blockquote:after:content-none
            prose-ul:text-foreground/80 prose-ol:text-foreground/80
            prose-a:focus-visible:outline-2 prose-a:focus-visible:outline-offset-2 prose-a:focus-visible:outline-brand
